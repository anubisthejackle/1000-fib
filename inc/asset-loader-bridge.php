...
function get_asset_dependencies( $asset ) {
	return Thousand_Fib\get_asset_dependencies( $asset );
}
...
function get_asset_hash( $asset ) {
	return Thousand_Fib\get_asset_hash( $asset );
}
...
function get_asset_path( $asset, $dir = false ) {
	return Thousand_Fib\get_asset_path( $asset, $dir );
}
...
function inline_locale_data( $to_handle ) {
	Thousand_Fib\inline_locale_data( $to_handle );
}
